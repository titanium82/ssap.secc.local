@adminaccessroutename('admin.exhibition_location.show')
<button type="button" data-route="{{ route('admin.exhibition_location.show', $id) }}" class="btn btn-icon btn-info open-modal-form">
    <i class="ti ti-eye"></i>
</button>
