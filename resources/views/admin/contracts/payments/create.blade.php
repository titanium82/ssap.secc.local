...
@section('content')
    <div class="page-body">
        <div class="container-xl">
            <x-core-form :action="route('admin.contract_payment.store')" type="post" :validate="true">
                <div class="row justify-content-center">
                    @include('admin.contracts.payments.forms.create-left')
                    @include('admin.contracts.payments.forms.create-right')
                </div>
