...
<head>
    ...
    <meta name="author" content="SSAP">
    <title>@lang('LogViewer')</title>
    {{-- Styles --}}
...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <div class="d-flex align-items-center">
            <a href="{{ route('admin.dashboard') }}" class="btn btn-secondary btn-icon text-white fs-5">
                <i class="fa fa-chevron-left" aria-hidden="true"></i>
            </a>
            <a href="{{ route('log-viewer::dashboard') }}" class="navbar-brand mr-0">
                <i class="fa fa-fw fa-book"></i> @lang('LogViewer')
            </a>
        </div>
