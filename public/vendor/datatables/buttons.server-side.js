(function ($, DataTable) {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: function (dt) {
            return '<i class="ti ti-file-spreadsheet"></i> ' + dt.i18n('buttons.excel', 'Excel');
        },
    ...
    DataTable.ext.buttons.postExcelVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="ti ti-file-spreadsheet"></i> ' + dt.i18n('buttons.excel', 'Excel (only visible columns)');
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: function (dt) {
            return '<i class="ti ti-file-spreadsheet"></i> ' + dt.i18n('buttons.csv', 'CSV');
        },
    ...
    DataTable.ext.buttons.postCsvVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="ti ti-file-spreadsheet"></i> ' + dt.i18n('buttons.csv', 'CSV (only visible columns)');
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: function (dt) {
            return '<i class="ti ti-rotate-2"></i> ' + dt.i18n('buttons.reset', 'Reset');
        },
